...
<style type="text/css">
	...
	.calendar button.month-less {left: 20px;background: url(../../../static/img/left-icon.png) no-repeat left -60px;}
	.calendar button.month-add {right: 20px;background: url(../../../static/img/right-icon.png) no-repeat left -60px;}
	...
	.calendar .ui-state-default{background: url(../../../static/img/checkin.png) no-repeat center center;}
