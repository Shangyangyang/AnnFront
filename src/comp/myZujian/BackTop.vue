<template>
	<transition name="el-fade-in">
		<div class="page-up" @click="scrollToTop" v-show="toTopShow">1111<i class="el-icon-caret-top"></i></div>
	</transition>
</template>
		...
		scrollToTop() {
			...
			timer = requestAnimationFrame(function fn() {
				if (_this.scrollTop > 5000) {
					...
					document.getElementsByClassName('content-container')[0].scrollTop = _this.scrollTop;
